...
public class ObsidianEquipment {
    ...
    public static final Item OBSIDIAN_PLATE = registerItem("obsidianeq/obsidian_plate", new Item(new FabricItemSettings().group(Initialize_Mod.EXPERT)));

    private static Item registerItem(String name, Item item) {
        return Registry.register(Registry.ITEM, new Identifier(Initialize_Mod.MOD_ID, name), item);
    }
    public static void registerModItems() {
        LOGGER.debug("Obsidian Equipment detected, adding Armor Plates");
    }
}