...
public class DragonLoot {
    ...
    public static final Item DRAGON_PLATE = registerItem("dragonloot/dragon_plate", new Item(new FabricItemSettings().group(Initialize_Mod.EXPERT)));

    private static Item registerItem(String name, Item item) {
        return Registry.register(Registry.ITEM, new Identifier(Initialize_Mod.MOD_ID, name), item);
    }
    public static void registerModItems() {
        LOGGER.debug("Dragon Loot detected, adding Armor Plates");
    }
}